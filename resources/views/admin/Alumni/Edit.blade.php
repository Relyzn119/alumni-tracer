                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <nav aria-label="breadcrumb" class="ms-auto">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit Alumni</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="ktp" accept="image/*"
                                        name="ktp">
                                    <img id="ktp-preview" src="" class="img-fluid mt-2" alt="KTP Preview"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="ijazah" accept="image/*"
                                        name="ijazah">
                                    <img id="ijazah-preview" src="" class="img-fluid mt-2" alt="Ijazah Preview"
                                        style="display:none; width: 200px; height: auto;" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="image-input" accept="image/*"
                                        name="file">
                                    <img id="image-preview" src="" class="img-fluid mt-2" alt="Image Preview"
                                        style="display:none; width: 200px; height: auto;" />
                                </div>
                            </div>
                        </div>
