                    ...
                    <div class="col">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <nav aria-label="breadcrumb" class="ms-auto">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('mahasiswa.index') }}">Home</a>
                                    </li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex gap-2">
                    <a href="{{ route('mahasiswa.create') }}" class="btn btn-outline-primary"><i
                    ...
                    <a href="{{ route('mahasiswa.index') }}" class="btn btn-outline-primary"><i
                            class="fa-solid fa-rotate-right me-2"></i>Refresh</a>
                    <div class="ms-auto">
                        <!-- Form Search -->
                        <form action="{{ route('mahasiswa.index') }}" method="GET" class="d-flex ms-auto">
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td class="d-flex gap-2">
                                            ...
                                            <a href="{{ route('mahasiswa.edit', $item->id) }}" class="btn btn-primary">
